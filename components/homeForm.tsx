...
//         setStatusMessage(data.error || "We couldn't submit the message. Please try again.");
//       }
//     } catch (error) {
//       console.error('Form submission error:', error);
//       setSubmitStatus('error');
//       setStatusMessage("Network error: We couldn't submit the message. Please check your connection and try again.");
//     }
//   };
...
//         <a href="https://policies.google.com/privacy" style={{ color: 'black', fontWeight: 400 }}>
//           Privacy Policy
//         </a>{' '}
//         and{' '}
//         <a href="https://policies.google.com/terms" style={{ color: 'black', fontWeight: 400 }}>
//           Terms of Service
//         </a>{' '}
//         apply.
//       </p>
...
export default function HomeForm({ styles }: HomeFormProps) {
  ...
  const handleSubmit = async(event: React.FormEvent<HTMLFormElement>) => {
    ...
    try{
      ...
      console.error('Form submission error:', error);
      alert("Network Error: We Couldn\'t submit the message, please try again!");
      setLoading(false);
    }finally{
      setLoading(false);
    }
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="contactUsFormSubmitButton"
        type="submit"
        style={{marginBottom: '24px', letterSpacing: '1.2', fontWeight: 600, cursor: 'pointer'}}
      >
